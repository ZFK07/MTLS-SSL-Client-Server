...
public class SSLServer {
  public static void main(String[] args) {
    try {
      ...
      InputStream inputStream = ClassLoader.getSystemClassLoader().getResourceAsStream("server/SERVERKEYSTORE.jks");
      ...
      InputStream inputStream1 =
              ClassLoader.getSystemClassLoader().getResourceAsStream("server/SERVERTRUSTSTORE.jks");
      ...
      sslContext.init(
          new KeyManager[] {x509KeyManager}, new TrustManager[] {x509TrustManager}, null);
